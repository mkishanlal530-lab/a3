...
<body>
  ...
  <header class="site-header">
    <div class="header-container">
      <a href="/" class="brand-logo" aria-label="Nectarineyum Home">
        <span class="logo-mark">◈</span>
        <span class="logo-text">Nectarineyum</span>
      </a>
  ...
  <div class="mobile-drawer" id="mobile-drawer" aria-hidden="true">
    <div class="drawer-header">
      <div class="drawer-brand">Nectarineyum</div>
    ...
    <div class="drawer-footer">
      ...
      <p class="drawer-contact-info">Email: concierge@nectarineyum.com</p>
    </div>
  </div>
    ...
    <div class="container">
      <div class="grid-2">
        <div>
          ...
          <p>
            At Nectarineyum, creation is approached not as transient commercial production, but as permanent architectural engineering. From our Manhattan atelier at 181 Mercer Street in SoHo, our master artisans combine century-old European guild traditions with advanced modern kinetic physics.
          </p>
          <p>
  ...
  <section class="section">
    <div class="container">
      <div class="section-header text-center">
        ...
        <h2>Four Architectural Pillars of Nectarineyum</h2>
        ...
        <table class="spec-table">
          <thead>
            <tr>
              ...
              <th>Nectarineyum Bespoke Standard</th>
    ...
    <div class="container">
      <div class="footer-grid">
        <div class="footer-col">
          ...
          <div class="footer-contact-item"><strong>Concierge:</strong> concierge@nectarineyum.com</div>
        </div>
        <div class="footer-col">
      ...
      <div class="footer-bottom">
        <p>&copy; 2026 Nectarineyum Ltd. All Rights Reserved. Master craft at 181 Mercer Street, New York, NY 10012.</p>
